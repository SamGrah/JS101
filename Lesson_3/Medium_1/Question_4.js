...
add and remove elements from a rolling buffer. However, once the buffer becomes
...
/////////    ANSWER   \\\\\\\\\
// I'd prefer concat() because it doesn't mutate the caller. Meaning that
// the locally scoped variable name buffer will be set to a new string
// without modifying the array at argument passed-by-reference